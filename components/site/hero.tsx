...
export function Hero() {
  ...
  return (
    <motion.div
      className="mx-auto grid w-full max-w-5xl gap-10 px-6 pb-16 pt-40 md:grid-cols-[1.3fr_1fr] md:items-center md:pb-24 md:pt-48"
    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">
          Hardware security, signal processing, and applied AI/ML — building
          at the layer where software meets silicon.
        </p>
